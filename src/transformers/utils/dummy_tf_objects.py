...
class TFLlamaForCausalLM(metaclass=DummyObject):
    _backends = ["tf"]
...
class TFLlamaForSequenceClassification(metaclass=DummyObject):
    _backends = ["tf"]
...
class TFLlamaModel(metaclass=DummyObject):
    _backends = ["tf"]
...
class TFLlamaPreTrainedModel(metaclass=DummyObject):
    _backends = ["tf"]
